...
document.addEventListener('DOMContentLoaded', () => {//cuando cargue el documentos se van a cargar todos los autos
    mostrarAutos(autos)
})
...
marca.addEventListener('input', (e) =>{//si hay algun cambio en los input 
...
year.addEventListener('input', (e) =>{//si hay algun cambio en los input 
...
minimo.addEventListener('input', (e) =>{//si hay algun cambio en los input 
...
maximo.addEventListener('input', (e) =>{//si hay algun cambio en los input 
...
puertas.addEventListener('input', (e) =>{//si hay algun cambio en los input 
...
transmision.addEventListener('input', (e) =>{//si hay algun cambio en los input 
...
color.addEventListener('input', (e) =>{//si hay algun cambio en los input 
...
function limpiarHtml(){
    ...
    while(contenedor.firstChild){//mientras haya algo impreso 
        contenedor.removeChild(contenedor.firstChild)//se pone first child pq abajo estamos poniendo appenChild, tonces para q no se actualice abajo hay q ir remoiendo el primero
    }
}
...
function filtrarAuto(){//aca volvemos a llamar la funcion obtenerAutos para poder pitarlos todos otra ve y filtrarlos segun los cambios
    const resultado = obtenerAutos().filter(filtrarMarca).filter(filtrarYear).filter(filtrarMinimo).filter(filtrarMaximo).filter(filtrarPuertas).filter(filtrarTransmision).filter(filtrarColor)//el codigo q normalemnte filtra lo vamos a meter en esa funcion filtrarMarca,
    if(resultado.length){
...
function filtrarMarca(auto){// esto es lo mismo q   .filter(auto => {})  pero se hace con funcion por aparte
